  ...
  if (!course) {
    return (
      <div className="course-detail-global-wrapper">
        <Header />
        <div
          style={{ textAlign: "center", padding: "150px 0", color: "#94a3b8" }}
        >
          <i
            className="fa-solid fa-triangle-exclamation"
            style={{ fontSize: "40px", marginBottom: "15px", color: "#cbd5e1" }}
          ></i>
          <p>
            해당 코스의 상세 데이터를 찾을 수 없거나 데이터베이스가
            비어있습니다.
          </p>
          <button
      ...
      <div className="detail-container-inner">
        <div className="detail-main-card">
          ...
          <div
            ...
            style={{
              backgroundImage: `linear-gradient(rgba(0,0,0,0.1), rgba(0,0,0,0.4)), url(${course.imageUrl})`,
            }}
          >
            ...
            <div className="info-content-scroll">
              ...
              <div className="spec-grid-container">
                <div className="spec-item">
                  ...
                  <span className="spec-value" style={{ fontSize: "15px" }}>
                    자연 공원 인프라
                  </span>
                </div>
                <div className="spec-item">
              ...
              <div className="tag-cloud">
                {course.tagDetail.map((tag, index) => (
              ...
              <div className="detail-action-buttons">
                ...
                {/* <button
                  ...
                  onClick={() =>
                    alert(
                      "해당 공원 코스의 크루 모집 페이지 연동 준비 중입니다!",
                    )
                  }
                >
                  크루 참여하기
