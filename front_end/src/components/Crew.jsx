    ...
    <div className="crw-global-container">
      ...
      <section className="crw-recommended-section">
        <div className="crw-section-title-bar">
          <h3>
            <i className="fa-solid fa-star star-green"></i> 추천 크루 모집
          </h3>
          <button
        ...
        <div className="crw-recommended-grid">
          {topRecommendedCrews.map((crew) => (
            <div key={crew.id} className="crw-recom-card">
              <div
                className="crw-recom-img-holder"
              ...
              <div className="crw-recom-body">
                ...
                <p className="meta-info">
                  <i className="fa-solid fa-location-dot"></i> {crew.location}
                </p>
                <p className="meta-info">
                  <i className="fa-regular fa-calendar"></i> {crew.date}
                </p>
                <div className="meta-specs">
                  <span>
                    <i className="fa-solid fa-route"></i> {crew.distance}
                  </span>
      ...
      <main className="crw-split-main-dashboard">
        ...
        <section className="crw-board-left-container">
          <div className="crw-tab-header-menu">
            ...
            <button
              className={activeTab === "신규" ? "active" : ""}
              onClick={() => setActiveTab("신규")}
            >
              신규 모집
            </button>
            <button
              className={activeTab === "인기" ? "active" : ""}
          ...
          <div className="crw-list-items-stack">
                  ...
                  <div className="crw-list-row-details">
                    <div className="title-row-line">
                      <h5>
                        {crew.title}
                        {crew.isNew && (
                          <span className="new-flash-badge">NEW</span>
                        )}
                      </h5>
                    </div>
                    ...
                    <p className="row-item-sub-caption">
                      주말 아침, 함께 활기차게 코스 러닝 하실 분 모집합니다!
                    </p>
                  </div>
                  <div className="crw-list-row-right-status">
                    <div className="ratio-number">
                      <strong>{crew.current}</strong> / {crew.max}명
                    </div>
            ...
            {activeTab === "신규" && (
              <div className="crw-list-row-item placeholder-tab-card">
                ...
                <div className="crw-list-row-details">
                  <h5>신규 모집 페이지입니다</h5>
                  <p className="horizontal-spec-infos">
                    현재 등록된 가장 최신의 게시판 DB 리스트업 상태입니다.
                  </p>
                </div>
                <div className="crw-list-row-right-status">
                  <div className="ratio-number">
            ...
            {activeTab === "인기" && (
              <div className="crw-list-row-item placeholder-tab-card">
                ...
                <div className="crw-list-row-details">
                  <h5>인기 모집 페이지입니다</h5>
                  <p className="horizontal-spec-infos">
                    신청률 및 조회수가 높은 순으로 정렬된 공간입니다.
                  </p>
                </div>
                <div className="crw-list-row-right-status">
                  <div className="ratio-number">
                    <strong style={{ color: "#ef4444" }}>12</strong> / 12명
                  </div>
